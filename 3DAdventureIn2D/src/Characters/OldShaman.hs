...
firstDialog = [
  ...
  , " ???      : Believe me when I say that it wasn\'t easy."
  , " ???      : Learning it\'s language, I mean."
  , " ???      : They speak in \'up\'s and \'low\'s aswell, you understand?"
  , " ???      : I had to bribe it with flowers to even talk to me."
  , " ???      : A cylinder is by the wway a circle with a constant size. Within it's bounds."
  ...
  , "OldShaman : That\'s easy. Just grasp \'falling\'"
  , "OldShaman : It is what I did back then."
  , "OldShaman : You see falling is the ability to descend!"
  , "OldShaman : To descend through the flatlands."
  , "OldShaman : Do it right above the monster."
  , "OldShaman : That will scare it away."
  , "OldShaman : It will spit you out."
  , "OldShaman : And then descend into the unknown \'low\'."
  , "OldShaman : Two to three years of meditation here with me..."
  , "OldShaman : And you should see the \'low\'."
  , "OldShaman : Then you should be fine."
  , "OldShaman : Ohmmm..."
  , "Hero      : I can\'t wait so long, can\'t you help me."
  , "OldShaman : Stop it, the longer I talk with you the flatter I think."
  , "OldShaman : Just meditate over your experiences and my words..."
  , "OldShaman : Who knows, you might grasp it within a months if your smart."
  , "Oldshaman : Ohmmm..."
  ...
  , "OldShaman : You\'re to attached to your love."
  , "OldShaman : And to the material flatness, aswell."
  , "OldShaman : I\'ll help you to get my silence back..."
  , "OldShaman : You see falling is stepping over the bounds..."
  , "OldShaman : And then descending naturally by letting go..."
  , "OldShaman : I guess you won\'t understand..."
  , "OldShaman : Words are just not enough to describe it."
  ...
  , "OldShaman : And even if it hurts, is your love that shallow?"
  ...
  , "OldShaman : Come back once you freed yourself from the material..."
