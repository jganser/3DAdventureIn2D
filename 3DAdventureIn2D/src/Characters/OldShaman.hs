...
firstDialog = [
  ...
  , " ???      : Our the world isn\'t flat as we are?"
  ...
  , " ???      : They speal in \'up\'s and \'low\'s, you understand?"
  , " ???      : But that\'s no the point here."
  , " ???      : The point is to ascend the flat and to become \'spacial\'..."
  , " ???      : Now you know what it is I'm doing here."
  ...
  , "OldShaman : Ten to twenty years of meditation here with me..."
  , "OldShaman : And you should see the \'low\'."
  , "OldShaman : The you should be fine."
  , "OldShaman : Ohmmm..."
